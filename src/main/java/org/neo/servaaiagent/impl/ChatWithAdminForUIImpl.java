...
public class ChatWithAdminForUIImpl extends AbsChatForUIImpl {
    private ChatWithAdminForUIImpl() {
    }

    public static ChatWithAdminForUIImpl getInstance() {
        return new ChatWithAdminForUIImpl();
    }
    ...
    public String fetchResponse(String session, String userInput, List<String> attachFiles) {
        try {
            ...
            return (String)dbService.executeSaveTask(new ChatWithAdminForUIImpl() {
                @Override
